                                                                                                                            ...
                                                                                                                            .then(async productqty => {
                                                                                                                                ...
                                                                                                                                for (let i = 0; i < qty; i++) {
                                                                                                                                    await message.author.send(new MessageEmbed()
                                                                                                                                        .setTimestamp()
                                                                                                                                        .setFooter(client.user.username, client.user.displayAvatarURL())
                                                                                                                                        .addfield('__**What to do now ?**__', '<:Arrow:778967880230109185> Please, **enter** the name of the product you want to buy !!!\n<:example:801551839703072768> *For example you can enter : `Box Logo Hoodie, FW16, Black, Size M`*', false)
                                                                                                                                        ...
                                                                                                                                        .addauthor('Product 1 :')
                                                                                                                                        .setTitle(':placard: __**What is the Name of the Product you Want ?**__')).then(async () => {
                                                                                                                                        await message.author.dmChannel.awaitMessages(filter, {
                                                                                                                                                max: 1,
                                                                                                                                                time: 300000,
                                                                                                                                                errors: ['time']
                                                                                                                                                    ...
                                                                                                                                                    await message.author.dmChannel.awaitMessages(filter, {
                                                                                                                                                        ...
                                                                                                                                                        .then(async productDescription => {
                                                                                                                                                            ...
                                                                                                                                                            await message.author.send(new MessageEmbed()
                                                                                                                                                                ...
                                                                                                                                                                .setTitle(':straight_ruler: __** What Size(s) are you looking for ?**__')).then(async () => {
                                                                                                                                                                await message.author.dmChannel.awaitMessages(filter, {
                                                                                                                                                                        max: 1,
                                                                                                                                                                        time: 60000,
                                                                                                                                                                        errors: ['time']
