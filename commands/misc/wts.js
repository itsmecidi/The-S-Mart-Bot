                                                ...
                                                message.author.dmChannel.awaitMessages(filter, {
                                                    ...
                                                    .then(async country => {
                                                        ...
                                                        await message.author.send(new MessageEmbed()
                                                            ...
                                                            .addField('__**Hol\'Up Cowboy :**__', '<a:Verified1:778656791332257813> We **highly recommend** that you **specify your city** for potential Meet-Ups to increase your chance of selling !!!\n** ** ** **', false)
                                                            .setDescription('Need some <:Help:778973470792876032>, come open a ticket in <#778302895526903818>\n** ** ** **')
                                                            ...
                                                            cityorNo.awaitReactions(filterr, {
                                                                ...
                                                                .then(async collected1 => {
                                                                    ...
                                                                    await message.author.send(new MessageEmbed()
                                                                        ...
                                                                        .addField('__**Hol\'Up Amigos :**__', '<a:Verified1:778656791332257813> We highly **suggest** that you to **take the time** to copy your link :wink:\n<a:Verified1:778656791332257813> **References** tremendously **increase the seriousness** of your post and will **boost** your chance of selling, **don\'t sleep on it** !!!\n** ** ** **', false)
                                                                        .setDescription('Need some <:Help:778973470792876032>, come open a ticket in <#778302895526903818>\n** ** ** **')
                                                                        ...
                                                                        cityorNo.awaitReactions(filterr, {
                                                                            ...
                                                                            .then(async collected1 => {
                                                                                ...
                                                                                message.author.send(new MessageEmbed()
                                                                                                    ...
                                                                                                    .addField('__**Tips :**__','<a:verif:778656791332257813> If you want the **other part to pay** for the fees, you can enter `Buyer` !!\n<a:verif:778656791332257813> If your price **include** the shipping fees you can enter `Include` !!\n** ** ** **', false)
                                                                                                    .setDescription('Need some <:Help:778973470792876032>, come open a ticket in <#778302895526903818>\n** ** ** **')
                                                                                                    ...
                                                                                                    message.author.dmChannel.awaitMessages(filter, {
                                                                                                        ...
                                                                                                        .then(async fee => {
                                                                                                            ...
                                                                                                            await message.author.send(new MessageEmbed()
                                                                                                                ...
                                                                                                                .setColor('#7901FF')
                                                                                                                .setDescription('Need some <:Help:778973470792876032>, come open a ticket in <#778302895526903818>\n** ** ** **')
                                                                                                                .addField('__**What to do now ?**__', '<:Arrow:778967880230109185> Please **react** with the number of **different products** you\'re looking to sell !!!', false)
